...
function Tokens() {
  ...
  const SCOPES = ["read", "deploy", "cron", "db", "containers", "domains", "files", "backups", "security", "uptime", "runners", "catalog", "workspaces", "vault", "notify", "logs", "system", "settings", "media", "shell"];
