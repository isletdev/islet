...
export const NAV: NavItem[] = [
  { path: "/", label: "Overview", phase: "v0.1", blurb: "Live CPU, memory, disk and network, plus what needs attention." },
  { path: "/containers", label: "Containers", phase: "v0.2", blurb: "Every container, image, volume and Compose stack on this server." },
  { path: "/files", label: "Files", phase: "v0.2", blurb: "Browse, edit and move files without SSH." },
  { path: "/terminal", label: "Terminal", phase: "v0.1", blurb: "A shell on this server, in the browser." },
  ...
  { path: "/settings", label: "Settings", phase: "v0.1", blurb: "Users, 2FA, API tokens, updates." },
];
