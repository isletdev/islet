...
var minRole = map[string]string{
	...
	"DELETE /api/v1/media/worker":                                   admin,
	"GET /api/v1/media/buckets":                                     admin,
	"POST /api/v1/media/buckets":                                    admin,
	"POST /api/v1/media/buckets/{id}/check":                         admin,
	"DELETE /api/v1/media/buckets/{id}":                             admin,
	"GET /api/v1/media/keys":                                        admin,
	"POST /api/v1/media/keys":                                       admin,
	"DELETE /api/v1/media/keys/{id}":                                admin,
	"GET /api/v1/media/presets":                                     admin,
	"POST /api/v1/media/presets":                                    admin,
	"DELETE /api/v1/media/presets/{id}":                             admin,
